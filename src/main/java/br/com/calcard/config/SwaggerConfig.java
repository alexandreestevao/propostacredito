...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.calcard.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API Calcard",
                "Esta API é utilizada como documentação.",
                "Versão 1.0",
                "https://www.calcard.com/api/v1/docs",
                new Contact("Wesley F Pereira", "https://www.calcard.com/contatos", "contato@calcard.com"),
                "Permitido uso para membros do time Calcard",
                "https://www.calcard.com",
